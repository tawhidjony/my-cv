$(document).ready(function(){
    ...
    $.ajax({
          type:"get",
          url:"http://127.0.0.1:5500/db/skilled.json",
    ...
    //Language
      $.ajax({
          type:"get",
          url:"http://127.0.0.1:5500/db/language.json",
          contentType: "application/json",
          dataType: 'json',
          success: function(result){
    ...
    //Title
      // $.ajax({
      //     type:"get",
      //     url:"http://127.0.0.1:5500/db/title.json",
      //     contentType: "application/json",
      //     dataType: 'json',
      //     success: function(result){
    ...
    //Education
      $.ajax({
          type:"get",
          url:"http://127.0.0.1:5500/db/educations.json",
          contentType: "application/json",
          dataType: 'json',
          success: function(result){
    ...
    //Certification
      $.ajax({
          type:"get",
          url:"http://127.0.0.1:5500/db/certifications.json",
          contentType: "application/json",
          dataType: 'json',
          success: function(result){
    ...
    //exprience
      $.ajax({
          type:"get",
          url:"http://127.0.0.1:5500/db/exprience.json",
          contentType: "application/json",
          dataType: 'json',
          success: function(result){
    ...
    //hobbies
      $.ajax({
          type:"get",
          url:"http://127.0.0.1:5500/db/hobbies.json",
          contentType: "application/json",
          dataType: 'json',
          success: function(result){
    ...
    //Profile
      $.ajax({
          type:"get",
          url:"http://127.0.0.1:5500/db/profile.json",
          contentType: "application/json",
          dataType: 'json',
          success: function(result){
